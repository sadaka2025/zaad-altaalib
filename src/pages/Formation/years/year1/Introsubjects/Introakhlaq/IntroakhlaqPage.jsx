...
import akhlaqStats from '../../../../../../datastat/years/year1/akhlaq_stats.json';
...
export default function IntroAkhlaqPage() {
  ...
  const semesterData = data?.year1?.akhlaq?.[semesterKey] || {};
  ...
  // pour S1 / S2
  const semesterStats = akhlaqStats?.year1?.akhlaq?.[semesterKey] || {};

  // pour les stats annuelles
  const totalYearStats = akhlaqStats?.year1?.akhlaq?.yearStats || {};
  ...
  const goToLesson = (lessonId) => {
    navigate(
      `/ar/annee/1/matiere/akhlaq?semestre=${selectedSemester === 'semester1' ? 1 : 2}&lesson=${lessonId}`
    );
    ...
    <div className="font-[Arial] max-w-6xl mx-auto p-4 space-y-6">
      ...
      <div className="flex gap-4 justify-center my-6">
        <button
          ...
          onClick={() => {
            launchFlowers();
            navigate(`/${lang}/intro/1/akhlaq?semestre=1`);
          }}
        >
          📘 السداسي الأول
        </button>
        ...
        <button
          ...
          onClick={() => {
            launchFlowers();
            navigate(`/${lang}/intro/1/akhlaq?semestre=2`);
          }}
        >
          📗 السداسي الثاني
        </button>
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-4">
        ...
        <button
          onClick={() =>
            navigate(
              `/ar/annee/1/matiere/akhlaq?semestre=${selectedSemester === 'semester1' ? 1 : 2}`
            )
          }
