...
import data from '../../../../../../datatext/years/year2/datatxtnahw.json';
import courseDataJSON from '../../../../../../dataIntro/years/year2/dataLesson/lessonListnahw.json';
import nahwStats from '../../../../../../datastat/years/year2/nahw_stats.json';
...
export default function IntroNahwPage() {
  ...
  const semesterData = data?.year2?.nahw?.[semesterKey] || {};
  ...
  const semesterStats = nahwStats?.year2?.nahw?.[semesterKey] || {};
  const totalYearStats = nahwStats?.year2?.nahw?.yearStats || {};
  ...
  const goToLesson = (lessonId) => {
    if (!lessonId) return;
    navigate(
      `/ar/annee/2/matiere/nahw?semestre=${selectedSemester === 'semester1' ? 1 : 2}&lesson=${lessonId}`
    );
  ...
  if (!data?.year2?.nahw || !nahwStats?.year2?.nahw) {
    return (
    ...
    <div className="font-[Arial] max-w-6xl mx-auto p-4 space-y-6">
      ...
      <div className="flex gap-4 justify-center my-6">
        <button
          ...
          onClick={() => {
            launchFlowers();
            navigate(`/${lang}/intro/2/nahw?semestre=1`);
          }}
        >
          📘 السداسي الأول
        </button>
        ...
        <button
          ...
          onClick={() => {
            launchFlowers();
            navigate(`/${lang}/intro/2/nahw?semestre=2`);
          }}
        >
          📗 السداسي الثاني
        </button>
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-4">
        ...
        <button
          onClick={() =>
            navigate(
              `/ar/annee/2/matiere/nahw?semestre=${selectedSemester === 'semester1' ? 1 : 2}`
            )
          }
