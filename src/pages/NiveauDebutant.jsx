...
export default function NiveauDebutant() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/images/zitouna-bg.jpg')" // ✅ ضع صورة مناسبة في public/images
      }}
    >
        ...
        <div className="text-center mb-10">
          ...
          <div className="max-w-3xl mx-auto mb-6 shadow-lg rounded overflow-hidden">
            <video controls className="w-full rounded">
              ...
              {t("video_not_supported", { defaultValue: "Votre navigateur ne supporte pas la vidéo." })}
            </video>
          </div>
        </div>
