...
const subjects = [
  ...
  { name: "فن الدعوة والخطابة", icon: "🎙️", description: "فن الدعوة والخطابة هو مهارة الاتصال الفعال باستخدام الكلمات..." },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-green-100 p-6 rounded-2xl shadow">
            ...
            <p className="text-gray-700 leading-relaxed text-justify">
              شهادة الأهلية هي إحدى الشهادات الأساسية التي تمنحها مؤسسات التعليم الزيتوني...
            </p>
          </div>
          <div className="bg-blue-100 p-6 rounded-2xl shadow">
            <h3 className="text-xl font-semibold mb-4 text-blue-900">شهادة التحصيل</h3>
            <p className="text-gray-700 leading-relaxed text-justify">
              تُعتبر شهادة التحصيل الخطوة التالية في مسار التعليم الزيتوني...
            </p>
          </div>
        </div>
